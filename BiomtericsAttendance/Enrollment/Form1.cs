...
namespace Enrollment
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                string query = "SELECT te.FirstName,te.LastName,te.OtherName,te.MatricNo,te.Sex,te.StudentLevel,ta.val AS Present,ta.TodayDate from tbl_attendance ta JOIN tbl_student te ON te.MatricNo=ta.MatricNo where ta.TodayDate = '" + textBox1.Text + "'";
